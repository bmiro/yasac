...
package body semantica.comprovacio_tipus is
   ...
   procedure ct_dec_proc(proc: in ast; error: in out boolean);
	...
	procedure ct_dec_param(param: in ast; id_proc: in id_nom; error: in out boolean) is
   ...
   procedure ct_dec_params(params: in ast; id_proc: in id_nom; error: in out boolean) is
   begin   
